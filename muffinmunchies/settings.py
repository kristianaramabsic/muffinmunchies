"""
Django settings for muffinmunchies project.
...
SECRET_KEY = 'b2#y9jq_zmi1^jxz*c$$d)&n(h7+ckrdc1fd(*j(d(s#)dcn=7'
...
ROOT_URLCONF = 'muffinmunchies.urls'
...
WSGI_APPLICATION = 'muffinmunchies.wsgi.application'
...
#load local_settings if they exist
try:
